...
#define MBEDTLS_PSA_CRYPTO_STORAGE_C CONFIG_MBEDTLS_PSA_CRYPTO_STORAGE_C
#endif

#if defined(CONFIG_MBEDTLS_PSA_ITS_FILE_C)
#define MBEDTLS_PSA_ITS_FILE_C CONFIG_MBEDTLS_PSA_ITS_FILE_C
#endif

#if defined(CONFIG_MBEDTLS_FS_IO)
#define MBEDTLS_FS_IO CONFIG_MBEDTLS_FS_IO
#endif
